...
Office.onReady((info) => {
  if (info.host === Office.HostType.Mail) {
    ...
    document.getElementById("generatedBy").value = userEmail;
    ...
    document.getElementById("isRecurring").addEventListener("change", handleRecurringChange);
...
async function handleInjectAndLog() {
  ...
  if (activeTab === "newMeeting") {
    const isRecurring = document.getElementById("isRecurring").checked;
    action = isRecurring ? "Schedule Recurring Meeting" : "Schedule Meeting";
  } else {
